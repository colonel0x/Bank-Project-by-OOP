...
private: 
    ...
    {
        clsUI_Operations::clsTransActionMenue::ShowDepositScreen();
    }

    static void _ShowWithdrawScreen()
    {
        clsUI_Operations::clsTransActionMenue::ShowWithdrawScreen();
    }

    static void _ShowTotalBalancesScreen()
    {
        clsUI_Operations::clsTransActionMenue::ShowTotalBalances();
    }

    static void TransferScreen()
    {

         clsUI_Operations::clsTransActionMenue::ShowTransferScreen();

    }
    static void TransferLogScreen()
    {

        clsUI_Operations::clsTransActionMenue::ShowTransferLogScreen();

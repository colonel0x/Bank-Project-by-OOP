...
private:
    ...
    static clsCurrency _ConvertLinetoCurrencyObject(string Line, string Seperator = "#//#")
    {
        ...
        vCurrencyData = clsString::clsStr_Splits_Fun::SplitStringRecord(Line, Seperator);
...
public:
    ...
    static   clsCurrency FindByCode(string CurrencyCode)
    {
        ...
        CurrencyCode = clsString::clsStr_Change_Letter_UpperLower_Fun::ChangeStringToUpper(CurrencyCode);
    ...
    {
        Country = clsString::clsStr_Change_Letter_UpperLower_Fun::ChangeStringToUpper(Country);
        ...
        if (MyFile.is_open())
        {
            ...
            {
                clsCurrency Currency = _ConvertLinetoCurrencyObject(Line);
                TextCountry = clsString::clsStr_Change_Letter_UpperLower_Fun::ChangeStringToUpper(Currency.Country());
